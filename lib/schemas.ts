...
export type TriggerRules = z.infer<typeof triggerSchema>;
export type TargetingRules = z.infer<typeof targetingSchema>;
export type FrequencyRules = z.infer<typeof frequencySchema>;
