...
export const variantConfigSchema = z.object({
  ...
  imageWidth: z.number().min(20).max(800).default(100), imageWidthUnit: z.enum(["%", "px"]).default("%"),
  imageHeight: z.number().min(80).max(600).default(220), imageAspectRatio: z.enum(["square", "4:3", "portrait", "original"]).default("original"),
  imageFit: z.enum(["cover", "contain"]).default("cover"), imageVerticalAlign: z.enum(["top", "center", "bottom"]).default("center"),
  horizontalSplit: z.enum(["25/75", "33/67", "40/60", "50/50"]).default("33/67"), columnGap: z.number().min(0).max(80).default(24),
  innerPadding: z.number().min(0).max(80).default(32), formWidth: z.number().min(25).max(100).default(100), buttonWidth: z.number().min(25).max(100).default(100),
...
export const defaultVariant: VariantConfig = { headline:"Join the newsletter", body:"The best stories, delivered straight to your inbox.", supportingText:"No spam. Unsubscribe anytime.", emailPlaceholder:"Email address", cta:"Sign me up", imageUrl:"", imagePosition:"top", imageSize:30, imageWidth:100, imageWidthUnit:"%", imageHeight:220, imageAspectRatio:"original", imageFit:"cover", imageVerticalAlign:"center", horizontalSplit:"33/67", columnGap:24, innerPadding:32, formWidth:100, buttonWidth:100, hideImageMobile:true, layout:"vertical", presentation:"focus", fontFamily:"system", headlineFont:"system", fontSize:16, headlineSize:32, fontWeight:"600", align:"center", lineHeight:1.4, background:"#ffffff", textColor:"#475569", headlineColor:"#0f172a", buttonBackground:"#6366f1", buttonText:"#ffffff", inputBackground:"#ffffff", borderColor:"#cbd5e1", buttonRadius:10, buttonPadding:13, buttonFullWidth:true, buttonAlign:"center", closeButton:true };
