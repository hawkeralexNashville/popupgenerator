...
export async function GET(
  ...
  try {
    ...
    console.error("Public config loading failed", { publicSiteId: siteId, error });
    return NextResponse.json({ error: "Configuration is temporarily unavailable" }, { status: 503 });
  }
}
